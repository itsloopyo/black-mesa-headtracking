@echo off
:: ============================================
:: Black Mesa Head Tracking - Uninstall
:: ============================================
...
:: DLLs were deployed - the game root, since ASI_SUBDIR is empty.
...
:: own directory. This mod deploys AT the root, so MOD_LEFTOVERS covers them.
set "ROOT_EXTRAS="
...
:: match install.cmd's value, or uninstall looks in the wrong folder. Empty: this
:: mod deploys at the game root, because a proxy in bin\ never loads under Steam.
set "ASI_SUBDIR="
