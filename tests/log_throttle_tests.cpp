...
void TestAimSchedule() {
    ...
    // The second parameter set the throttle is specified for: four opening
    // lines, then every 600th frame until 20 lines have gone out, then every
    // 2000th for the rest of the session. aim_point.cpp's [aim] line runs on
    // it.
