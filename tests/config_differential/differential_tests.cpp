...
// the file it last read. `game` stands for the folder holding bms.exe.
...
// says, the smoothing pair), and src/position_mapping.h:13-46 (the position sensitivity, LimitY
