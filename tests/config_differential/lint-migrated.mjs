...
//
// Runs core's canonical config lint over config/CameraUnlock.ini, the committed file,
...
const perGame = (format.per_game["black-mesa-headtracking"] ?? []).map((entry) => entry.row);
if (perGame.length > 0) {
